...
const appCss = "/assets/styles-DmvWv-n0.css";
...
const $$splitComponentImporter = () => import("./index-CQmTwZVX.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "SISFIA: OCR del libro diario, transacciones, análisis, solvencias y tasas BCV para Nueva Acrópolis Venezuela."
    }]
  }),
