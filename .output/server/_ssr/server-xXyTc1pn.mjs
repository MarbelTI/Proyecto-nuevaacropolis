...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Jy4WMfoj.mjs");
...
const manifest = {
  "89c5997d61a574f97b6f398f7bf6f1e8f6e83007e7f854d9375024f4816dc8d6": {
    ...
    importer: () => import("./bcv.functions-uxcN4CLN.mjs")
  },
  ...
  "e96338824bfb704932733f5e53742a990d80f57d37b38264f7d9fcbe46f3a095": {
    ...
    importer: () => import("./ocr.functions-ix3ep5AF.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-bnZe0PZx.mjs"),
    import("./start-CQEyVJN2.mjs"),
